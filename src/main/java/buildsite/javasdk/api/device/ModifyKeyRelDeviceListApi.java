...
import buildsite.javasdk.http.HttpPutMethod;
import buildsite.javasdk.request.RequestInfo;
import buildsite.javasdk.response.BasicResponse;
import buildsite.javasdk.response.device.ModifyKeyRelDeviceResponse;
